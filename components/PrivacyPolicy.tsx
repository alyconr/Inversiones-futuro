...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto bg-slate-50 dark:bg-slate-900/40 p-8 md:p-12 rounded-3xl border border-slate-200 dark:border-slate-800">
      <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-8 text-center">Política de Tratamiento de Datos Personales</h2>
      ...
      <div className="space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl text-sm border border-blue-100 dark:border-blue-800 italic">
